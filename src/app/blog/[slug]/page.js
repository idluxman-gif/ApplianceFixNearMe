...
export function generateStaticParams() {
  return blogArticles.filter(a => a.published).map((a) => ({ slug: a.slug }));
}
...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.appliancefixnearme.com/blog/${article.slug}`,
    },
  };
}
...
export default function BlogArticlePage({ params }) {
  ...
  const jsonLd = {
    ...
    author: { "@type": "Organization", name: "ApplianceFixNearMe.com" },
    publisher: {
      "@type": "Organization",
      name: "ApplianceFixNearMe.com",
      url: "https://www.appliancefixnearme.com",
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://www.appliancefixnearme.com/blog/${article.slug}`,
    },
  };
      ...
      <article style={{ maxWidth: 680, margin: "0 auto", padding: "32px 20px 48px" }}>
        ...
        <div style={{
          ...
          <h3 style={{ margin: "0 0 8px", fontSize: 20, fontWeight: 800, color: "#fff" }}>
            Find Appliance Repair Shops Near You
          </h3>
          <p style={{ fontSize: 13, color: "rgba(255,255,255,.5)", margin: "0 0 16px" }}>
            Browse our directory of verified repair shops across all 50 states.
          </p>
          <Link href="/" style={{
            display: "inline-block", padding: "12px 28px", background: "#EA580C",
